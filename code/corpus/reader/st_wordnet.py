# -*- coding: utf-8 -*-
# Natural Language Toolkit: st_wordnet
#
# Copied from wordnet.py
...
class Synset(_WordNetObject):
    ...
    def __init__(self, wordnet_corpus_reader):
        ...
        # StWordNetCorpusReader._synset_from_pos_and_line()
...
class StWordNetCorpusReader(CorpusReader):
    """
    ...
    def __init__(self, root, omw_reader):
        ...
        directory.
        """
        super(StWordNetCorpusReader, self).__init__(
    ...
    def _synset_from_pos_and_line(self, pos, data_file_line):
        ...
        try:
            ...
            #print("_synset_from_pos_and_line: columns_str=", columns_str)
            gloss = gloss.strip()
            #print("_synset_from_pos_and_line: gloss=", gloss)
            definitions = []
            ...
            #print("_synset_from_pos_and_line: lexname_index=", lexname_index)
            if lexname_index < 45:
        ...
        for lemma in synset._lemmas:
            ...
            tup = (
                lemma._name,
                StWordNetCorpusReader._pos_numbers[synset._pos],
